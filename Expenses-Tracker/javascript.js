...
function updateSummary(){
    ...
    //here acc => 0 then add with transaction.amount then return
    ...
    expenseAmountEl.textContent = formateCurrency(Math.abs(expenses))
}
...
function removeTransaction(id){
    //filter out the one we wante to delete
